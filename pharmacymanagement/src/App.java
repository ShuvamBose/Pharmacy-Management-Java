    ...
    public static void main(String args[]){
        ...
        if(ip==1){
            ...
            if(ip1==1){
                ...
                LogIn o = new LogIn(obj.getPhone(),obj.getPass(),true);
                ...
                if(ip11==1){
                    ...
                    SignUp o2 = new SignUp(obj.getName(), obj.getPhone(), obj.getPass(),ip);
                    usr=false;
                }
                else{
                    LogInView obj = new LogInView();
                    LogIn o = new LogIn(obj.getPhone(),obj.getPass(),usr);
                    usr=false;
                }
        }
        else{
